...
public class ModificarContenidoVentana extends PlantillaBaseVentana {
    ...
    protected void inicializarComponentes() {
        JPanel panelContenido = crearPanelDegradadoDecorativo("Gestión de Contenido");
        ...
        JScrollPane scrollPane = crearScrollPaneTransparente(panelContenido);
        ContenidoConPanelSuperior panelSuperior = new ContenidoConPanelSuperior(scrollPane);

        getPanelContenedor().add(panelSuperior, BorderLayout.CENTER);
    }
...
mysql> INSERT INTO TBL_TIPO_EJERCICIO (nombre) VALUES ("ejercicio"), ("cuestiona
rio");
